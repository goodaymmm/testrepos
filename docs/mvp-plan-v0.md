...
project-root に Kairon を init
  -> Codex / Claude / Gemini terminal session を開始
...
- Terminal-backed Gemini session
- Review Loop Manager
- Work Queue
- Agent Dispatcher
- Context Builder
...
- `kairon start` が Runtime Host と Codex / Claude / Gemini Terminal-backed Session を起動する。
